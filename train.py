...
class RestorationDataset(Dataset):
    def __init__(self, degraded_dir, clean_dir, patch_size=192):
        super().__init__()
...
def main():
    ...
    # --- 資料加載 ---
    train_dataset = RestorationDataset(TRAIN_DEGRADED, TRAIN_CLEAN, patch_size=192)
    ...
    log_filename = 'training_log_v3.csv'
    ...
    for epoch in range(EPOCHS):
        ...
        # 定期存檔
        if (epoch + 1) % 10 == 0:
            torch.save(model.state_dict(), f'v3_epoch{epoch+1}.pth')
